    ...
    _initGameManifest: function () {
        if (cc.sys.platform === cc.sys.WIN32) {
            if (AssetsManager.ENABLE_TEST_LOCAL) {
                ...
                this._gameManifest.setLocalInfo(1, "http://portal-gsn.mto.zing.vn/dominoid_cdn_event");
            }
            return;
        }

        let pathProjectManifest = fr.NativeService.getFolderUpdateAssets() + "/project.manifest";
